...
public class WCSRequestConfig
{
    ...
    /**
     * liefert den f�r den WCS eingestellten URL.<p>
     * @return URL
     */
    ...
    /** 
     * setzt den Service-Namen f�r den WCS. Voreingestellt ist der Wert "WCS". Ein Aufruf dieser Methode ist nur dann
    ...
    /** 
     * setzt die BBOX f�r den WCS-Request.<p> 
     ...
     * Es ist sicherzustellen, dass der angesprochene WCS dieses Format auch unterst�tzt.<p>
     ...
     * Es ist sicherzustellen, dass der angesprochene WCS diese Einstellung auch unterst�tzt.<p>
     ...
     * Es ist sicherzustellen, dass der angesprochene WCS die jeweilige Einstellung auch unterst�tzt.<p>
    ...
    /**
     * liefert den URL f�r den GetCapabilities-Request an den WCS.<p>
    ...
    /**
     * liefert den URL f�r den GetMap-Request an den WCS.<p>
     * TODO resX/resY und width/height Parameter �berarbeiten...
     * @return vollst�ndigen URL f�r den GetCoverage-Request
     */    
