...
/**
 * Class to hold tetrahedronal meshes. Note that <tt>VgTetraMesh</tt> objects 
 ...
 * <tt>VgIndexedTetrMesh</tt> allows to access structures consisting of 
 * indexed vertices.
 * 
...
abstract public class VgTetrMesh extends VgGeomObject3d 
{
	...
	/**
	 * returns the number of tetrahedrons that are part of the mesh.
	 * 
	 * @return Number of tetrahedrons
	 */
	abstract public int numberOfTetrahedrons();
	...
	/**
	 * returns the i-th tetrahedron of the mesh structure. The assertion
