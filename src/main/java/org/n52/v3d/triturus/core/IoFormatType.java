...
/**
 * I/O format type constants. Within this framework, these constants are used in
 * I/O implementations of various readers and writers. Note that not all formats
 * supported by the 52N Triturus framework have been &quot;registered&quot; as
 * <tt>IoFormatType</tt> here; for rare formats, often implementation specific
 * type constants or character strings are used!
 *
...
public class IoFormatType {
    ...
    /**
     * File-format type identifier to be used for Shape file format.
     */
